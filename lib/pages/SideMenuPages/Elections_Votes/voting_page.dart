...
class VotingPage extends StatefulWidget {
  ...
  const VotingPage({Key? key, required this.electionId, required this.onVoteSubmitted}) : super(key: key);
...
class _VotingPageState extends State<VotingPage> {
  ...
  Future<void> _fetchElectionData() async {
    final snapshot = await FirebaseFirestore.instance.collection('Elections').doc(widget.electionId).get();
    if (snapshot.exists) {
      final electionData = snapshot.data() as Map<String, dynamic>;
      setState(() {
        candidates = List<Map<String, dynamic>>.from(electionData['candidates'] ?? []);
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: const Row(
                        ...
                        children: [
                          Icon(Icons.how_to_vote_outlined, size: 16, color: Colors.black54),
                          SizedBox(width: 8),
                          Text(
              ...
              Container(
                ...
                child: ElevatedButton(
                  onPressed: _selectedCandidateIndex == null || _isVotingInProgress
                    ...
                    candidates[candidateIndex]['voteCount'] = (candidate['voteCount'] ?? 0) + 1;
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      ...
                      fontWeight: FontWeight.bold,
                      letterSpacing: 1,
                      color: _selectedCandidateIndex == null || _isVotingInProgress
